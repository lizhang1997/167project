...
Server::Server()
{
    ...
    GameObjectRegistry::sInstance->RegisterCreationFunction( 'PUBG', PubgServer::StaticCreate );
...
namespace
{
    ...
    void CreateRandomPubg()
    {
        ...
        //make a mouse somewhere- where will these come from?
            go = GameObjectRegistry::sInstance->CreateGameObject( 'PUBG' );
            Vector3 pubgLocation = RoboMath::GetRandomVector( mouseMin, mouseMax );
            go->SetLocation( pubgLocation );
